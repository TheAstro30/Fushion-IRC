...
{   
    ...
    public class Theme
    {
        ...
        public Theme()
        {
            ...
            Messages.Add(ThemeMessage.ChannelSelfText, new ThemeMessageData { DefaultColor = 1, MessageFormat = "$ts <12$prefix$me> $text" });
            Messages.Add(ThemeMessage.ChannelActionText, new ThemeMessageData { DefaultColor = 6, MessageFormat = "$ts * $prefix$nick $text" });
            Messages.Add(ThemeMessage.ChannelSelfActionText, new ThemeMessageData { DefaultColor = 13, MessageFormat = "$ts * $prefix$me 6$text" });
            ...
            Messages.Add(ThemeMessage.PrivateSelfText, new ThemeMessageData { DefaultColor = 1, MessageFormat = "$ts <12$me> $text" });
            Messages.Add(ThemeMessage.PrivateActionText, new ThemeMessageData { DefaultColor = 6, MessageFormat = "$ts * $nick $text" });
            Messages.Add(ThemeMessage.PrivateSelfActionText, new ThemeMessageData { DefaultColor = 13, MessageFormat = "$ts * $me 6$text" });
